...
export const teacherApi: TeacherApi = {
  ...
  listGroupPresets: (classroomId) => call("list_group_presets", { classroomId }),
  getGroupPreset: (classroomId, presetId) => call("get_group_preset", { classroomId, presetId }),
  createGroupPreset: (request) => call("create_group_preset", { request }),
  updateGroupPreset: (request) => call("update_group_preset", { request }),
  deleteGroupPreset: (classroomId, presetId) => call("delete_group_preset", { classroomId, presetId }),
  getSessionGrouping: (sessionId) => call("get_session_grouping", { sessionId }),
  createGroupingDraftFromPreset: (request) => call("create_grouping_draft_from_preset", { request }),
  createRandomGroupingDraft: (request) => call("create_random_grouping_draft", { request }),
  createManualGroupingDraft: (sessionId) => call("create_manual_grouping_draft", { request: { sessionId } }),
  cloneCurrentGroupingDraft: (sessionId) => call("clone_current_grouping_draft", { sessionId }),
  updateSessionGroupingDraft: (request) => call("update_session_grouping_draft", { request }),
  openSessionGroupingDraft: (draftId) => call("open_session_grouping_draft", { draftId }),
  moveSessionGroupingParticipant: (request) => call("move_session_grouping_participant", { request }),
  cancelSessionGroupingDraft: (draftId) => call("cancel_session_grouping_draft", { draftId }),
  finalizeSessionGroupingDraft: (draftId) => call("finalize_session_grouping_draft", { draftId }),
