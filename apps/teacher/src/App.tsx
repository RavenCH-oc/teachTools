...
export function App({ api = teacherApi, reviewApi = peerReviewApi }: AppProps) {
...
function Classrooms({ api, data, onChange, onError, onOpenSessionHistory, onOpenGrouping }: { api: TeacherApi; data: Classroom[]; onChange: (items: Classroom[]) => void; onError: (message: string) => void; onOpenSessionHistory: () => void; onOpenGrouping: (classroomId: string) => void }) {
