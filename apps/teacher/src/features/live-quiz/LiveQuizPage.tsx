...
export function LiveQuizPage({ api, onError, onOpenSessionAnalysis, onOpenSessionGrouping }: { api: LiveQuizApi; onError: (message: string) => void; onOpenSessionAnalysis?: (session: LocalSession) => void; onOpenSessionGrouping?: (session: LocalSession) => void }) {
